#!/usr/bin/env python3
"""
Setup Wizard for Personal Multi-Agent Chatbot System
"""
import os
import sys
...
def run_setup_wizard():
    ...
    console.print(Panel.fit(
        "🚀 Welcome to Personal Multi-Agent Chatbot Setup",
        title="Setup Wizard",
        border_style="blue"
    ))
...
def create_config_files(config: Dict):
    ...
    # Create .env file
    env_content = f"""# Personal Multi-Agent Chatbot System Configuration
